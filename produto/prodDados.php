...
$rs = $conn->prepare("SELECT p.id, p.nome, p.descricao, p.codigo, c.nome as categoria
from produto p
    ...
    <table border="2" class="table table-hover" >
        ...
        <?php while ($linha = $rs->fetch(PDO::FETCH_OBJ)): ?>
            <tr> 
                ...
                <td><?php echo "<a href='prodEditar.php?id=$linha->id&nome=$linha->nome&descricao=$linha->descricao&codigo=$linha->codigo&categoria=$linha->categoria' class='btn btn-info'>Editar</a>"; ?></td>
